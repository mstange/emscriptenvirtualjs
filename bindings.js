...
function initObject(object, __class__, thisptr) {
  object.ptr = thisptr;
  if (!('__cache__' in __class__.prototype)) {
    __class__.prototype.__cache__ = {};
  }
  __class__.prototype.__cache__[thisptr] = object;
  object.__class__ = __class__;
}
Module['initObject'] = initObject;
...
function ValueProvider(){ throw "ValueProvider is abstract!" }
ValueProvider.prototype.__cache__ = {};

ValueProvider.prototype.getValue = function() {
    return _emscripten_bind_ValueProvider__getValue_p0(this.ptr);
}
function _emscripten_extern_ConstValueProvider_getValue(thisptr) {
  return ConstValueProvider.prototype.__cache__[thisptr].getValue();
}
